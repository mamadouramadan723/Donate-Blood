...
import com.rmd.giveblood.model.User;
        ...
        if (requestCode == AUTHUI_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                if (user.getMetadata().getCreationTimestamp() == user.getMetadata().getLastSignInTimestamp()) {
                    ...
                    userId = user.getUid();
                    phone_number = "";
                    image_url = "https://firebasestorage.googleapis.com/v0/b/give-blood-d9244.appspot.com/o/applogo.png?alt=media&token=f6eacec4-1027-4cad-b587-1b18ff1cdc32";
