...
import com.rmd.giveblood.databinding.FragmentDonateOrRequestListBinding;
import com.rmd.giveblood.main.Activity_Login_Register;
import com.rmd.giveblood.model.Donate_or_Request;
import com.rmd.giveblood.ui.recyclerAdapter.Recycler_Adapter_Donate_or_Request;
...
public class Fragment_Request_List extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        donate_request_ref = FirebaseFirestore.getInstance().collection("requests");
        ...
        donate_request_ref.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for (QueryDocumentSnapshot document : value) {
                    ...
                    recyclerAdapterDonateRequest = new Recycler_Adapter_Donate_or_Request(requireContext(), requireActivity(),  Fragment_Request_List.this, donateOrRequestList);
